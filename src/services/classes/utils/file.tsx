...
class FileUtil {
  ...
  public static getViewUrl(id: string) {
    return this.getUrl(id, UrlType.View);
  }

  public static getDownloadUrl(id: string, token: string) {
    return this.getUrl(id, UrlType.Download, token);
  }
   ...
   * @memberof FileUtil
   */
  public static getUrl(id: string, type: UrlType, token?: string) {
  ...
  public static getType(mimetype?: string) {
    ...
    const fileType = this.groups.find((item: any) => item.mimetypes.indexOf(mimetype) > -1);
