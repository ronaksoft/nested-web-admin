...
SystemJS.config({
  ...
  map: {
    ...
    'react-draft-wysiwyg': 'npm:react-draft-wysiwyg@1.7.7',
  ...
  packages: {
    ...
    'npm:react-draft-wysiwyg@1.7.7': {
      'map': {
        'draftjs-utils': 'npm:draftjs-utils@0.7.5',
        'immutable': 'npm:immutable@4.0.0-rc.9',
        'classnames': 'npm:classnames@2.2.6'
      }
    },
    'npm:draftjs-utils@0.7.5': {
      'map': {
        'immutable': 'npm:immutable@3.8.2'
      }
    },
